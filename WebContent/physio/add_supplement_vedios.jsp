      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<% if(request.getAttribute("vedio_add_msg")!=null)out.println(request.getAttribute("vedio_add_msg"));%>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" enctype="multipart/form-data" action ="supplement_shop_add_vedios">
                         
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><h4>Vedio</h4></label>
                              <div class="col-sm-10">
                                  <input type="file" class="form-control" accept="vedio" name="vedio" >
                              </div>
                          </div>
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><h4>Topic</h4></label>
                              <div class="col-sm-10">

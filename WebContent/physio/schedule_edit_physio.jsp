		...
		<div class="form">
			<fieldset>
				...
				<form action="Schedule_update" method="post"
					...
					Physio NIC :<input type="text" name="Physio_NIC" value='${schedule.physio_NIC}'
						required="true" readonly="true"><br>  
						
					Customer NIC : <input type="text" name="Customer_NIC" value="<c:out value='${schedule.customer_NIC}'/>" readonly="true"><br>

					Age :<br> <input type="text" name="Age" value="<c:out value='${schedule.age}'/>" required="true" readonly="true"><br>

					Height :<br> <input type="text" name="Height" value="<c:out value='${schedule.height}'/>" placeholder="In cm" 
						required="true"><br> 
						
					Weight : <input type="text" name="Weight" value="<c:out value='${schedule.weight}'/>"
						placeholder="in kgs" required="true" ><br> 
						
					Photos : <input type="file" name="Photo" value="<c:out value='${schedule.photos}'/>" required="true" r><br>

					...
					<div class="row">
						<div class="col-md">
							<div class="heading-section text-center animate-box">
								<div align="center">
								<form action="disAddQuestion" method="post">
									<table class="table borderless">
										<tbody>
											<tr>
												<td align="right"><strong><big>Topic</big></strong></td>
												<td width="1%"></td>
												<td><input type="text" class="form-control" name="topic" required></td>
											</tr>
											<tr>
												<td align="right"><strong><big>Category</big></strong></td>
												<td width="1%"></td>
											...
											<tr>
												<td align="right"><strong><big>Question</big></strong></td>
												<td width="1%"></td>
												<td><textarea class="form-control"
														name="question" rows="3"></textarea></td>
											</tr>
											<tr>
												<td align="right"><strong><big></big></strong></td>
												<td width="1%"></td>
												<td><input type="submit"
													class="btn btn-secondary btn-lg btn-block" value="Ask!"></td>
											</tr>
										</tbody>
									</table>
									</form>

...
<html lang="en">
  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a  href="supplement_shop_view_vedios.jsp"><span>manage videos</span></a>
                  </li>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h1 class="mb">Edit logo</h1>
                  	  	<div class="project-wrapper">
		                    <div class="project">   
		                            <div class="photo">
		                            	<a><img class="img-responsive" src="../<%out.println(newsession.getAttribute("company_logo")); %>" alt="no logo yet "  height="200" width="200" ></a>
		                            </div>
		                ...
		                <br>
		                <br>
                      <form class="form-horizontal style-form" method="post" enctype="multipart/form-data" action="supplement_shop_upload_logo">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><h4>logo</h4></label>
                              <div class="col-sm-10">
    ...
    <script src="profile/assets/js/jquery.js"></script>
    <script src="profile/assets/js/bootstrap.min.js"></script>
    <script class="include" type="text/javascript" src="profile/assets/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="profile/assets/js/jquery.scrollTo.min.js"></script>
    <script src="profile/assets/js/jquery.nicescroll.js" type="text/javascript"></script>


    <!--common script for all pages-->
    <script src="profile/assets/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="profile/assets/js/jquery-ui-1.9.2.custom.min.js"></script>

	<!--custom switch-->
	<script src="profile/assets/js/bootstrap-switch.js"></script>
	
	<!--custom tagsinput-->
	<script src="profile/assets/js/jquery.tagsinput.js"></script>

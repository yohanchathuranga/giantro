	...
	<div class="container2" style="background-image: url(Resources/physio/images/header.jpg);">
		...
		<nav class="nav" style="color: black;">
			...
			<label for="users">Choose User Type:</label>
				<ul >
				<li><a href="supplement_shop/supplement_shop_login.jsp" style="color:#FF0000;">Supplement Shop</a></li>	
				<li><a href="physio/Physio_login.jsp" style="color:#FF0000;">Phyiotherapists</a> <br></li>
				<li><a href="#" style="color:#FF0000;">Gym</a> <br></li> 
				<li><a href="user/user_login.jsp" style="color:#FF0000;">Customer</a></li>
			</ul>
		</nav>

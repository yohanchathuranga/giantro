...
@WebServlet("/Appointment_edit_user") // annotation servlet mapping
public class Appointment_edit_user extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private AppointmentDAO appointmentDAO;

	public Appointment_edit_user() {
		super();
	...
	private void showEditFormApp(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("user/Appointment_Edit.jsp"); // dispatcher
																									// return
																									// page
